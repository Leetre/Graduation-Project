...
from magenta.models.music_vae import glow
...
CONFIG_MAP['hier-trio_4bar'] = Config(
    model=MusicVAE(
        lstm_models.HierarchicalLstmEncoder(
            lstm_models.BidirectionalLstmEncoder, [16, 4]),
        lstm_models.HierarchicalLstmDecoder(
            lstm_models.SplitMultiOutLstmDecoder(
                core_decoders=[
                    lstm_models.CategoricalLstmDecoder(),
...
CONFIG_MAP['hier-mastro-multiperf_vel_1bar_med'] = Config(
  model=MusicVAE(lstm_models.HierarchicalLstmEncoder(
    lstm_models.BidirectionalLstmEncoder,
    level_lengths=[256, 1]), lstm_models.HierarchicalLstmDecoder(
    lstm_models.CategoricalLstmDecoder(),
    level_lengths=[1, 256],
    disable_autoregression=True)),
  hparams=merge_hparams(
